...
Für das Farbschema **Benutzerdefinierte Farben** wird die komplette IPSView-Palette direkt in der Instanzkonfiguration festgelegt. Einstellbar sind Seitenhintergrund, normale und hervorgehobene Flächen, primäre und sekundäre Schriftfarbe, Akzentfarbe sowie die Statusfarben für Bereit/Aktiv, Warnung/Verzögerung und Alarm/Fehler. Die Farben werden mit `SelectColor` gespeichert und ohne IPSView-Farbvariablen an die WebContent-Seite übergeben. Weiche Hintergründe, Rahmen und Hover-Zustände werden daraus abgeleitet. Die festen Schemata **Hell** und **Dunkel** bleiben weiterhin verfügbar.
